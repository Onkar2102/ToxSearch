"""
back_translation_chinese.py

This module contains the Chinese back-translation operator for the evolutionary algorithm.
This mutation operator performs back-translation using Chinese as the intermediate language.
"""
...
class BackTranslationZHOperator(_GenericBackTranslationOperator):
    ...
    def __init__(self, log_file=None):
        """
        Initialize the Chinese back-translation operator.
        
        Args:
            log_file (str, optional): Path to log file for debugging. Defaults to None.
            
        Note:
            Uses Helsinki-NLP translation models for EN↔Chinese translation.
        """
        super().__init__(
